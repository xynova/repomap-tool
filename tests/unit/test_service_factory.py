...
from repomap_tool.cli.services.service_factory import ServiceFactory, get_service_factory, clear_service_cache
...
class TestServiceFactory:
    ...
    def test_create_repomap_service(self):
        ...
        with patch('repomap_tool.cli.services.service_factory.create_container') as mock_create_container:
            ...
            with patch('repomap_tool.cli.services.service_factory.RepoMapService') as mock_repo_map_service:
                mock_service = Mock()
    ...
    def test_create_repomap_service_caching(self):
        ...
        with patch('repomap_tool.cli.services.service_factory.create_container') as mock_create_container:
            ...
            with patch('repomap_tool.core.repo_map.RepoMapService') as mock_repo_map_service:
                mock_service = Mock()
                mock_repo_map_service.return_value = mock_service
    ...
    def test_create_entrypoint_discoverer(self):
        ...
        with patch('repomap_tool.cli.services.service_factory.create_container') as mock_create_container:
            ...
            with patch('repomap_tool.core.repo_map.RepoMapService') as mock_repo_map_service:
                ...
                with patch('repomap_tool.cli.services.service_factory.EntrypointDiscoverer') as mock_discoverer:
                    ...
                    discoverer = self.factory.create_entrypoint_discoverer(repo_map, self.config)
    ...
    def test_create_tree_builder(self):
        ...
        with patch('repomap_tool.cli.services.service_factory.create_container') as mock_create_container:
            ...
            with patch('repomap_tool.core.repo_map.RepoMapService') as mock_repo_map_service:
                ...
                with patch('repomap_tool.cli.services.service_factory.TreeBuilder') as mock_tree_builder:
                    ...
                    # Create TreeBuilder
                    tree_builder = self.factory.create_tree_builder(repo_map, self.config)
    ...
    def test_create_tree_manager(self):
        ...
        with patch('repomap_tool.cli.services.service_factory.create_container') as mock_create_container:
            ...
            with patch('repomap_tool.core.repo_map.RepoMapService') as mock_repo_map_service:
                ...
                with patch('repomap_tool.cli.services.service_factory.TreeManager') as mock_tree_manager:
                    ...
                    # Create TreeManager
                    tree_manager = self.factory.create_tree_manager(repo_map, self.config)
