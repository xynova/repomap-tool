...
class TestTreeSitterTagCache:
    ...
    def test_cache_invalidation_on_file_change(self, cache, sample_tags, temp_cache_dir):
    ...
    def test_cache_invalidation_on_file_deletion(self, cache, sample_tags, temp_cache_dir):
