...
from repomap_tool.dependencies import (
    ImportAnalyzer, DependencyGraph, CentralityCalculator,
    CallGraphBuilder, AdvancedDependencyGraph, ImpactAnalyzer,
    Import, FileImports, ProjectImports, FunctionCall, CallGraph,
    DependencyNode, ImpactReport
)
...
""")
    ...
    def test_get_call_statistics(self):
        ...
        call_graph = CallGraph(
            project_path="/test",
            function_calls=[
                FunctionCall(caller="func1", callee="func2", file_path="/test/file.py", line_number=1),
                FunctionCall(caller="func2", callee="func3", file_path="/test/file.py", line_number=2)
            ],
            function_locations={"func1": "/test/file.py", "func2": "/test/file.py", "func3": "/test/file.py"}
        )
...
class TestAdvancedDependencyGraph:
    ...
    def test_integrate_call_graph(self):
        ...
        call_graph = CallGraph(
            project_path="/test",
            function_calls=[
                FunctionCall(caller="func1", callee="func2", file_path="/test/file1.py", line_number=1)
            ],
    ...
    def test_calculate_transitive_dependencies(self):
        ...
        # Add nodes to NetworkX graph
        graph.graph.add_node('/test/file1.py', **graph.nodes['/test/file1.py'].model_dump())
        graph.graph.add_node('/test/file2.py', **graph.nodes['/test/file2.py'].model_dump())
...
class TestImpactAnalyzer:
    ...
    def test_calculate_risk_score(self):
        ...
        risk_score = analyzer._calculate_overall_risk_score(['file1.py'], {'file1.py', 'file2.py'})
