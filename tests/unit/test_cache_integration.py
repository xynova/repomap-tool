...
class TestCacheIntegration:
    ...
    def test_cache_invalidation_on_initialization(self):
        ...
        from repomap_tool.models import RepoMapConfig, FuzzyMatchConfig, SemanticMatchConfig
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('repomap_tool.core.repo_map.get_project_files') as mock_get_files:
    ...
    def test_get_cache_status(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('repomap_tool.core.repo_map.get_project_files') as mock_get_files:
                ...
                assert Path(status["project_root"]).resolve() == Path(temp_path).resolve()
