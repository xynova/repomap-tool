...
class TestPerformanceConfig:
    ...
    def test_default_config(self):
        ...
        assert config.allow_fallback is False  # Development-focused: fail fast by default
...
class TestParallelTagExtractor:
    ...
    def test_get_performance_metrics(self):
        ...
        extractor._stats = ProcessingStats(total_files=10, successful_files=8, failed_files=2)
        extractor._stats.total_identifiers = 25
        extractor._stats.processed_files = 10  # Need to set this for files_per_second calculation
