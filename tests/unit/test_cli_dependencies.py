...
class TestCLIDependencies:
    ...
    def test_analyze_dependencies_command_exists(self, cli_runner):
        ...
        assert "Analyze project dependencies and build dependency graph" in result.output
    ...
    def test_impact_analysis_multiple_files(self, cli_runner, temp_project):
        ...
        with patch('repomap_tool.cli.DockerRepoMap') as mock_repo_map:
            ...
            mock_instance = Mock()
            mock_instance.analyze_change_impact.side_effect = [mock_report1, mock_report2]
            mock_repo_map.return_value = mock_instance
    ...
    def test_cli_error_handling(self, cli_runner, temp_project):
        ...
        with patch('repomap_tool.cli.DockerRepoMap') as mock_repo_map:
            mock_instance = Mock()
            mock_instance.build_dependency_graph.side_effect = RuntimeError("Dependency analysis is not enabled")
            mock_repo_map.return_value = mock_instance
