...
EXPECTED_PYTHON_FILES = ["core.py", "cli.py", "models.py", "__init__.py"]
...
PERFORMANCE_TEST_QUERIES = ["RepoMap", "matcher", "config", "search", "analyze"]
...
HYBRID_CONFIG = {"fuzzy_match": FUZZY_CONFIG, "semantic_match": SEMANTIC_CONFIG}
...
ERROR_TEST_CASES = [
    ...
    {"name": "short_query", "query": "a", "expected_behavior": "graceful_handling"},
    {
...
PERFORMANCE_BENCHMARKS = {
    "fuzzy_only": {"max_time": 10.0, "description": "Fuzzy search only mode"},
    "semantic_only": {"max_time": 10.0, "description": "Semantic search only mode"},
    "hybrid": {"max_time": 15.0, "description": "Hybrid search mode"},
}
