...
""")
    ...
    def test_centrality_table_vs_individual_consistency(self, test_project, llm_analyzer):
        ...
        for file_path in project_files:
            ...
            individual_rankings[file_path] = self._parse_table_rankings(individual_result)
