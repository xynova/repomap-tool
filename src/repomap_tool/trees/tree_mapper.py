...
class TreeMapper:
    ...
    def generate_tree_map(self, tree: ExplorationTree, include_code: bool = True) -> str:
        ...
        if expansion_points:
            ...
            for point in expansion_points:
                output.append(f"  • {point} - expand with: repomap-tool expand \"{point}\"")
    ...
    def _generate_tree_representation(self, node: TreeNode, include_code: bool, prefix: str = "") -> str:
        ...
        for i, child in enumerate(node.children):
            ...
            child_output = self._generate_tree_representation(child, include_code, child_prefix)
    ...
    def generate_export_format(self, tree: ExplorationTree, format_type: str = "json") -> str:
    ...
    def _export_as_json(self, tree: ExplorationTree) -> str:
        ...
        try:
            ...
            export_data = {
                ...
                "tree_structure": self._serialize_tree_node(tree.tree_structure) if tree.tree_structure else None
            }
