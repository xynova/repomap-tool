...
class ConfigDefaults:
    ...
    # === COMPRESSION LEVELS ===
    COMPRESSION_LEVELS: List[str] = None
...
class ConfigService:
    ...
    def get_all_defaults(self) -> Dict[str, Any]:
        ...
        """
        return {
            key: value for key, value in self.defaults.__dict__.items()
    ...
    def get_analysis_timeout(self) -> int:
        ...
        return self.get('ANALYSIS_TIMEOUT')
    
    def get_default_limit(self) -> int:
        """Get default result limit."""
        return self.get('DEFAULT_LIMIT')
    
    def get_max_depth(self) -> int:
        """Get maximum tree depth."""
        return self.get('MAX_DEPTH')
    
    def get_cache_size(self) -> int:
        """Get cache size."""
        return self.get('CACHE_SIZE')
    ...
    def get_compression_levels(self) -> List[str]:
        ...
        return self.get('COMPRESSION_LEVELS')
    ...
    def validate_max_tokens(self, tokens: int) -> bool:
        ...
        Returns:
            True if valid, False otherwise
        """
        min_tokens = self.get('MIN_TOKENS')
        max_tokens = self.get('MAX_TOKENS_LIMIT')
    ...
    def validate_timeout(self, timeout: int) -> bool:
        ...
        Returns:
            True if valid, False otherwise
        """
        min_timeout = self.get('MIN_TIMEOUT')
        max_timeout = self.get('MAX_TIMEOUT')
