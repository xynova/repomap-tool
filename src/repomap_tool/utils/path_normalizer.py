...
class PathNormalizer:
    ...
    def __init__(self, project_root: str):
        ...
        logger.debug(f"PathNormalizer initialized with project root: {self.project_root}")
        ...
        try:
            ...
            if path.is_absolute():
                try:
                    ...
                    logger.warning(f"Path {file_path} is not relative to project root {self.project_root}")
                    return str(path)
